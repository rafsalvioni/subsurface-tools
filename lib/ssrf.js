 ...
 * 
 * @see https://github.com/subsurface/subsurface/blob/b56b7abcf5d6f47f86493f7f246697bd7a785b79/core/units.h#L276
 * @param {number} bar Pressure, in bars
 * @returns number
 */
function barToMeters(bar)
{
    return Math.rounds(Math.log(DEFAULT_PRESSURE / bar) * 7800, 1);
}
